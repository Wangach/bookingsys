...
$sql = "SELECT * FROM consoles WHERE pshours = '$searchTime' AND bookstatus = '0'";
...
if (mysqli_num_rows($exec) > 0) {
	...
	echo "All Playstations Have Been Booked For This Specific Hour! Please Try Another Playing Time.";
}
